...
def matching(df_test, dict_fp, threshold):
    ...
    for name, click_logs in test_session:
        ...
        for item in click_items:
            ...
            val = prediction(set(click_items), dict_fp[item])
...
def prediction(click_item, item_pattern):
...
if __name__ == "__main__":
    ...
    "start"
    # call function
    result =  matching(df_test, dict_fp, threshold)
